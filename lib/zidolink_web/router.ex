defmodule ZidolinkWeb.Router do
  use ZidolinkWeb, :router

  import ZidolinkWeb.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {ZidolinkWeb.Layouts, :root}
  ...
  # scope "/api", ZidolinkWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:zidolink, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: ZidolinkWeb.Telemetry
